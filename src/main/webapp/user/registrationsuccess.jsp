...
<head>
  ...
  <meta http-equiv="Refresh" content="4;url=../index.jsp"> <!-- redirects after 5 secs -->
</head>
<body>
...
<div class="container">
  ...
  <div class="alert alert-primary" role="alert">
    ...
    <hr>
    <p class="mb-0">You will be redirected automatically to our main page in a few seconds.</p>
  </div>
